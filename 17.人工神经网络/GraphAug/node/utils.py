...
class ParserBase:
    def __init__(self):
        ...
        self.parser.add_argument(
            '--adj-corrupt', action='store_true', help='adjacency matrix corruption using xor')
...
def drop_node(
    adj: np.matrix, feat: np.matrix, prob: float, step: int, idx: int
) -> np.matrix:
