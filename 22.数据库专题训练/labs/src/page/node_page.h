...
class NodePage : public Page {
 public:
   ...
   * @param bLeaf 是否为叶结点
   */
  NodePage(FieldType iKeyType, bool bLeaf);
  /**
   ...
   * @return false 插入失败
   */
  void Insert(Field *pKey, const PageSlotID &iPair);
  /**
   ...
   */
  void Range(Field *pLow, Field *pHigh, std::vector<PageSlotID> &res);
